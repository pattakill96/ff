...
public class UtenteView {
	...
	public void show(Utente utente1) throws IOException {
		System.out.println("Pagina dell'utente :"+utente1.getUsername());
		System.out.println("\n(1)Visualizza profilo\n(2)Cerca Gioco\n(3)Valuta e recensisci gioco\n(4)Esci");
		String line = reader.readLine();
		//SCHIFEZZA BRUTTISSIMA
		Utente utente=utenteController.login(utente1.getUsername(), utente1.getPassword());
		if(line.equals("1")){
			...
			System.out.println("Vuoi visualizzare la scala dei livelli del giocatore?(0/1)");
